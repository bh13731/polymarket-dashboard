/* ════════════════════════════════════════════════════════════════════════
   The Speculator's Ledger — interactivity layer
   D3 charts + sortable tables + decision aggregation + watchlist filter

   Note: data is fetched from a local data.json under our control. We still
   escape every string derived from data before injecting into HTML, to
   keep the boundary clean (defense in depth).
   ════════════════════════════════════════════════════════════════════════ */
